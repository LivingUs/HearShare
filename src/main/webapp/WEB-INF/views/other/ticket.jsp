...
<br>
		...
		<div id="content_section">
			...
			<div id="mid_2" class="mid">
				<p id="p_text">현재 정기권이 <br><br><span style="font-size : 50px; font-weight: 900">
					<c:if test="${studyTicket.tYn ne null}">
						${studyTicket.tYn }
					</c:if>
					<c:if test="${studyTicket.tYn eq null}">
						0
					</c:if>
				</span>개 남았습니다.</p><br>
		...
		<div id="tb_ticket">
			<div class="tab">
				...
				<div class="tab_content">
					...
					<div class="tabs_item">
						<iframe src="studyTicketList.do" style="width:100%; height:211px; border:none;">
						</iframe>
					</div> 
				</div>
			</div> 
	...
	<div id="Buy_main">
			...
			<hr>
			<p>테마룸(스터디룸)의 정기권을 구매할 수 있습니다.<br>
	...
	<script>
	    ...
	    function getPayModuleStudy() {
	        ...
	        IMP.request_pay({
	            ...
	            if ( rsp.success ) {
	            	$.ajax({
	            		url : "insertStudyTicket.do",
	            		type : "POST",
	            		data : {"tPriceNo" : $tPriceNo},
	            		success : function(data) {
	            			alert("결제에 성공하였습니다");
	            			location.href="payAllList.do"
	            		}
	            	})
	            } else {
	                msg = '결제에 실패하였습니다.';
