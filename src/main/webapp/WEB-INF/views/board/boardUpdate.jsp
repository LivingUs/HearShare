				...
				<section>
					...
					<form action="boardUpdate.do" method="post" enctype="multipart/form-data">
							...
							<select class="custom-select" name="bHead">
								<option>글머리를 선택해주세요.</option>
								<c:choose>
									<c:when test="${board.bHead eq '소통해요' }">
										<option value="소통해요" selected>소통해요</option>
										<option value="궁금해요">궁금해요</option>
										<option value="건의해요">건의해요</option>
									</c:when>
									<c:when test="${board.bHead eq '궁금해요' }">
										<option value="소통해요">소통해요</option>
										<option value="궁금해요" selected>궁금해요</option>
										<option value="건의해요">건의해요</option>
									</c:when>
									<c:when test="${board.bHead eq '건의해요' }">
										<option value="소통해요">소통해요</option>
										<option value="궁금해요">궁금해요</option>
										<option value="건의해요" selected>건의해요</option>
									</c:when>
								</c:choose>
							</select>
							<br>
