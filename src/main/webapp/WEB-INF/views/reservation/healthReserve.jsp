     ...
     <!-- 내부 코드 -->
		...
		<section> <!--섹션 부분 수정-->
		    <div style="width:100%;">
		        ...
		        <button onclick="location.href='healthPay.do'" style="width: 300px; height: 40px; background-color: rgb(255, 186, 179); border: none; float: right; color: white; border-radius:4px; position:relative; right:40px;">
