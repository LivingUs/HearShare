...
<script>
	...
	<div id="wrapper">
		<div id="main_section">
			<p id="title" align="center">헬스룸 체크인</p>
				...
				<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"> 
					<div class="modal-dialog modal-dialog-centered" role="document"align="center"> 
						<div class="modal-content">
							<form action="checkSelectHealth.do" method="get">
				...
				success : function(data) {
					...
					if(data.length > 0){
						...
						for(var i in data){
							...
							$input = $("<input type='checkbox' value='"+data[i].rNo+"' name='healthCheck'>");
							$label.append($input);
