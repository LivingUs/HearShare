...
public class PageInfo {
	...
	public String toString() {
		return "PageInfo [currentPage=" + currentPage + ", boardLimit=" + boardLimit + ", pageLimit=" + pageLimit
				...
				+ maxPage + ", getCurrentPage()=" + getCurrentPage() + ", getBoardLimit()=" + getBoardLimit()
				+ ", getPageLimit()=" + getPageLimit() + ", getStartPage()=" + getStartPage() + ", getEndPage()="
				+ getEndPage() + ", getListCount()=" + getListCount() + ", getMaxPage()=" + getMaxPage()
